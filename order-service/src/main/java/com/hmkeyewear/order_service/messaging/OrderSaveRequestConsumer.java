...
// LoggerFactory.getLogger(OrderSaveRequestConsumer.class);

// private final ObjectMapper objectMapper;
// private final OrderService orderService;
// private final OrderMapper orderMapper;

// public OrderSaveRequestConsumer(ObjectMapper objectMapper, OrderService
...
// // Convert JSON → DTO
// OrderSaveRequestDto saveDto = objectMapper.readValue(message,
// OrderSaveRequestDto.class);

// OrderRequestDto orderRequestDto = orderMapper.toOrderRequestDto(saveDto);
// LOGGER.info("Order saved successfully for user: {}",
